            ...
            <div class="left-column">
                ...
                <div class="card room-code">
                    ...
                    <div className='deletion'>
                        ...
                        <button><svg class="svg-icon-del" viewBox="0 0 20 20">
                    ...
                    <table className='member-table'>
                        ...
                        {members.map((member, index) => (
                            <tr>
                                <td>{member.name}</td>
                                <td>{member.email}</td>
                                <td>{member.joined_at.split("T")[0]}</td>
                                {member.id === roomData.admin_id ? (
                                    <td><p style={{ color: "green" }}>Admin</p></td>
                                ) : (
